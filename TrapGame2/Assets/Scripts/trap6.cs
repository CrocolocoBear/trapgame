...
public class trap6 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (hasTriggered == false)
        {
            ...
            {
                StartCoroutine(GameObject.FindGameObjectWithTag("Player1").GetComponent<Player>().Knockback(2, new Vector3(15f, 10f, 0)));
            }
            ...
            {
                StartCoroutine(GameObject.FindGameObjectWithTag("Player1").GetComponent<Player>().Knockback(2, new Vector3(25f, 10f, 0)));
            }
